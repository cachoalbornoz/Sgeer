...
<table class="table table-hover">
    ...
    <tr>
        <td><a href="javascript:void(0)" onclick="encuesta('<?php echo $registro_encuestas[0] ?>','<?php echo $registro_encuestas[1] ?>')"><?php echo $registro_encuestas[1] ?></a></td>
        <td><?php echo $registro_encuestas[2] ?> </td>
        <td><a href='javascript:void(0)' title='Modifica encuesta' onClick="modifica_encuesta('<?php echo $registro_encuestas[0] ?>')"><span class="glyphicon glyphicon-pencil"></span></a></td>
        <td><a href='javascript:void(0)' title='Elimina encuesta actual' onClick="elimina_encuesta('<?php echo $registro_encuestas[0] ?>', '<?php echo $registro_encuestas[1] ?>')"><span class="glyphicon glyphicon-trash"></span></a></td>
    </tr>
    <?php
}
?>
