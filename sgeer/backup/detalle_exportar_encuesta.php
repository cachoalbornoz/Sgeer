...
if(isset($_POST['marca'])){
    ...
    if($_POST['marca'] == 1){
        ...
        $registro_encuestas = mysqli_fetch_array($tabla_encuestas, MYSQLI_BOTH);
        ...
        if(mysqli_fetch_array($tabla_archivo, MYSQLI_BOTH)){
        ...
        while($registro_cerrada = mysqli_fetch_array($tabla_cerrada, MYSQLI_BOTH)){ 
        ...
        while($registro_encuestas = mysqli_fetch_array($tabla_encuestas, MYSQLI_BOTH)){ 
            ...
            while($registro_preguntas = mysqli_fetch_array($tabla_preguntas, MYSQLI_BOTH)){ 	
                ...
                try {
                    ...
                    $registro_respuesta = mysqli_fetch_array($tabla_respuesta, MYSQLI_BOTH);
        ...
        echo "Se exportaron <b>$contador</b> encuestas.<br>";
    }
    if($_POST['marca'] == 2){
        $id_archivo 	= $_POST['id'];
...
while($registro_archivos = mysqli_fetch_array($tabla_archivos, MYSQLI_BOTH)){ 	
?>
    <tr>
        <td><?php echo $registro_archivos['nombre'] ?></td>
        <td><?php echo $registro_archivos['fecha'] ?></td>
        <td><a href='javascript:void(0)' onClick="descarga_archivo('<?php echo $registro_archivos['nombre'] ?>')" title='Descargar archivo'>( Descargar )</td>
        <td><a href='javascript:void(0)' onClick="borrar_archivo('<?php echo $registro_archivos[0] ?>','<?php echo $registro_archivos['nombre'] ?>')" title='Borrar archivo'>( Borrar )</td>
    </tr>
<?php 
}
