...
<style>
    ...
    body{
        background: url("sgeer/public/imagenes/office2.jpg") no-repeat center center fixed;
    ...
    <div class="container">           
        ...
        <form class="form-signin" method="post" action="sgeer/registro/verifica_usuario.php">  
            ...
            <div class="row" style=" background-color: grey; border-radius: 5px ">
                <div class="col-xs-12" style=" text-align: center">
                    <h4 style="color: whitesmoke; font-weight: bold">Sistema Gestor Encuestas</h4>
                </div>            
            </div>
            ...
            <div class="text-center" style="color: whitesmoke; font-weight: bold">                
                <?php 
        ...
        <footer class="navbar-default navbar-fixed-bottom navbar-inverse">
            <div class="owl-carousel owl-theme" style="text-align: center;font-weight: bold; color: blanchedalmond">
                <div class="item"><h6>&reg; S.G.E. 2015-<?php echo date('Y',time()) ?></h6></div>
                <div class="item"><h6><span class="glyphicon glyphicon-globe"></span> Encuestas Geo Referenciadas</h6></div>
                <div class="item"><h6><i class="fa fa-area-chart" aria-hidden="true"></i> Resultados Gráficos</h6></div>
                <div class="item"><h6><i class="fa fa-clock-o" aria-hidden="true"></i> Procesamiento Ágil</h6></div>
                <div class="item"><h6><i class="fa fa-rocket" aria-hidden="true"></i> Apps Livianas </h6></div>
            </div>
        </footer>
    </div>     
